<template>
  <div style="display: inline;">
    <el-button @click="handleTree">选择保存路径</el-button>
    <el-dialog title="请选择存图路径" v-model="visible" width="70%" height="70%" align-center>
      ...
      <template v-else >
        <div>
          <bread-crumbs4 class="bread-crumbs"></bread-crumbs4>
        <div
          v-if="
...
import { useFileStore4 } from "@/stores/file";
import { Base64 } from "js-base64";
import { storeToRefs } from "pinia";
import Item from "@/components/ListingItem4.vue";
...
const itemWeight = ref<number>(0);
  ...
  (e: "selectSavePath", libPath: string): void;
}>();
